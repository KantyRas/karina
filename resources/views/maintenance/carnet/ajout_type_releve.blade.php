...
@section('title','Ajout Type de relevé')
@section('content')
    <div class="col-lg-12">
        <h1 class="page-header">Nouveau Type de relevé</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('carnet.store_type_releve') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                <label for="nom_type" class="form-label fw-bold">Type de relevé</label>
                                <input type="text" class="form-control" id="nom_type" name="nom" placeholder="Entrez le nom du type" required>
                            </div>
